...
class Policy(nn.Module):
    def __init__(self, a_dim):
        ...
        #  Start of your code  #
        ########################
        self.cnn1 = nn.Conv2d(3, 24, kernel_size=5, stride=2)
        self.cnn2 = nn.Conv2d(24, 36, kernel_size=5, stride=2)
        self.cnn3 = nn.Conv2d(36, 48, kernel_size=5, stride=2)
        self.cnn4 = nn.Conv2d(48, 64, kernel_size=3)
        self.cnn5 = nn.Conv2d(64, 64, kernel_size=3)
        ########################
        #   End of your code   #
        ########################
